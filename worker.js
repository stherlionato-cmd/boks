...
// ============================
// 🚀 ROTAS (COMPATÍVEL COM SUA HOME)
// ============================

if(path === "api/cpf.php") return handleCPF(url)
if(path === "api/cpf2.php") return handleCPF(url) // pode trocar depois
...
// 🔥 exemplo (troca pela sua API real)
return json({
  status:true,
...
if(!res.ok){
  return json({status:false,message:"Erro na API"})
}
